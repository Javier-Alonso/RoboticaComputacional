...
# Parámetros D-H:
#		1		2		23		3		4		51		52		61		62		EF
d  = [p[0],     0,      0,    	0,   	5,      1,      1,   p[5],  	p[5], 1+p[5]]
th = [	0,    p[1],     90,   	90,  90+p[3],   0,    	0,    	0,     	0,     	0]
a  = [	2,		2,      0,     	0,     	0,      p[4], -p[4],    0,     	0,     	0]
al = [	0,		90,     90,   p[2],   	0,      0,      0,      0,      0,     	0]
...
T516 = matriz_T(d[7],th[7],a[7],al[7])
T526 = matriz_T(d[8],th[8],a[8],al[8])
T4EF = matriz_T(d[9],th[9],a[9],al[9])
...
T061=np.dot(T051, T516)
T062=np.dot(T052, T526)
...
o510=np.dot(T051,o515).tolist()
o520=np.dot(T052,o525).tolist()
o610=np.dot(T061,o616).tolist()
o620=np.dot(T062,o626).tolist()
