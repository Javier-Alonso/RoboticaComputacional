...
o610=np.dot(T061, o661).tolist()
o620=np.dot(T062, o662).tolist()
oef0=np.dot(T0ef, oef).tolist()

# Mostrar resultado de la cinemática directa
muestra_origenes([o00,o10,o20,o30,o40,o50,[[o610],[o620]]],oef0)
muestra_robot   ([o00,o10,o20,o30,o40,o50,[[o610],[o620]]],oef0)
input()
